    ...
    for (const roomId in rooms) {
        ...
        switch(rooms[roomId]){
            case "OK":
                ...
                accessButton.innerHTML = `<img src="./images/2507_login.png" alt="login" width="30">`;
                //accessButton.classList.add("btn");
                accessButton.addEventListener("click", () => {
                    JoinRoom(roomId);
                });
                roomElement.appendChild(accessButton);*/
                roomElement.classList.remove("room-not-ok");
                roomElement.classList.add("room-ok");
                //roomElement.innerHTML = `<div class="big-icon">▶️</div>`;
                roomElement.innerHTML = `<img src="./images/2507_login.png" onclick="JoinRoom(` + roomId +`)" alt="closed" width="80px">`;
                break;
            case "NOSTART":
                roomElement.classList.remove("room-ok");
                roomElement.classList.add("room-not-ok");
                //roomElement.innerHTML = `<div class="big-icon">🕒</div>`;
                roomElement.innerHTML = `<img src="./images/2507_close.png" alt="closed" width="80px">`;
                break;
            case "REQUIRED_LOGIN":
                roomElement.classList.remove("room-ok");
                roomElement.classList.add("room-not-ok");
                //roomElement.innerHTML = `<div class="big-icon">🔒</div>`;
                roomElement.innerHTML = `<img src="./images/2507_lock.png" alt="rqlogin" width="80px">`;
                break;
            case "NOT_PARTICIPANT":
                roomElement.classList.remove("room-ok");
                roomElement.classList.add("room-not-ok");
                //roomElement.innerHTML = `<div class="big-icon">⛔</div>`;
                roomElement.innerHTML = `<img src="./images/2507_block.png" alt="notpct" width="80px">`;
                break;
            case "LOST_CONNECTION":
                roomElement.classList.remove("room-ok");
                roomElement.classList.add("room-not-ok");
                //roomElement.innerHTML = `<div class="big-icon">❌</div>`;
                roomElement.innerHTML = `<img src="./images/2507_internet.png" alt="noconn" width="80px">`;
                break;
            default:
                roomElement.classList.remove("room-ok");
                roomElement.classList.add("room-not-ok");
                //roomElement.innerHTML = `<div class="big-icon">🔄</div>`;
                roomElement.innerHTML = `<img src="./images/circleloader.gif" alt="loading" width="80px">`;
                break;
        }
    }
}
